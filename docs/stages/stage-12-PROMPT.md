...
The latest report marks Idris 2 FK and geometric-Jacobian workloads as
...
2. Implement the matching base-frame geometric-Jacobian adapter, including the
...
- Idris FK and Jacobian results pass the shared 2R oracle, or the report
